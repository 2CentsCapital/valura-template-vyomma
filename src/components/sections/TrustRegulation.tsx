    ...
    >
      <div className="max-w-[1080px] mx-auto px-4 sm:px-6 flex flex-col items-center">
        <div className="flex flex-col items-center max-w-[780px] mx-auto text-center px-2">
          <p className="mb-4 inline-flex rounded-full bg-[#eef2ff] px-3.5 sm:px-4 py-1 sm:py-1.5 font-display text-xs sm:text-[13px] font-extrabold text-indigo-700">
            Trust, in specifics
          </p>
          <SplitText
            id="trust-title"
          ...
          <p className="font-display text-[15px] sm:text-[17px] text-[#475569] leading-[1.7] mb-8 sm:mb-10 max-w-[680px]">
            Rupees move under LRS to an IFSC entity, and reporting comes back
            consolidated, in INR and USD, ready for your tax workflow.
          </p>
        </div>

        <div className="w-full max-w-[720px] rounded-2xl sm:rounded-[24px] border border-slate-200 bg-[#fafafc] p-5 sm:p-8 shadow-[0_4px_7px_rgba(0,0,0,0.04)]">
