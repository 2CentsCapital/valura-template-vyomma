...
export default function Footer() {
  ...
  // The shader only starts once the footer is close to view, and never for reduced motion.
  const animate = nearViewport && !reduceMotion && canUseWebGL(1)
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-2 lg:grid-cols-[2fr_1fr_1fr] gap-8 gap-x-6 sm:gap-10 lg:gap-12 mb-12 sm:mb-16">
          <div className="flex flex-col items-start col-span-2 lg:col-span-1">
            ...
            <a
              href={`#${LEAD_FORM_ID}`}
              className="bg-white/10 backdrop-blur-sm border border-white/25 text-white font-sans font-medium text-sm sm:text-[15px] px-5 sm:px-6 py-2.5 rounded-[8px] hover:bg-white/20 transition-colors"
            >
              Talk to us
            </a>
          ...
          <nav
            aria-label="Explore"
            className="flex flex-col items-start lg:ml-auto"
          >
