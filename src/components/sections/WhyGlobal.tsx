        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          <div className="w-full lg:w-[45%] flex flex-col items-start shrink-0">
            ...
            <ul className="flex flex-col gap-5 sm:gap-7 lg:gap-[30px] mb-8 sm:mb-10 lg:mb-[56px] w-full">
              {POINTS.map((point) => (
                <li key={point} className="flex items-start gap-3.5 sm:gap-4">
                  <CheckIcon />
            ...
            <a
              href="#invest"
              className="w-full sm:w-auto text-center bg-gradient-to-b from-brand-blue to-brand-blue-deep hover:brightness-110 transition-all text-white font-sans font-bold text-base sm:text-lg lg:text-[20px] px-8 sm:px-[40px] py-3.5 sm:py-[16px] rounded-[14px] sm:rounded-[16px] shadow-lg shadow-blue-500/20 active:scale-[0.98]"
            >
          ...
          <div className="w-full lg:w-[55%] flex flex-col sm:relative items-center lg:items-end mt-4 sm:mt-8 lg:mt-0">
            <div className="relative w-full max-w-[661px] aspect-[4/3] sm:aspect-[16/11] lg:aspect-auto lg:h-[540px] xl:h-[598px] rounded-2xl sm:rounded-[30px] bg-slate-100 overflow-hidden shadow-xl">
              <img
